...
This project is indexed by GitNexus as **little-leap-aql** (9736 symbols, 16158 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
