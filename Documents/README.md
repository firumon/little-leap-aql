...
- 2026-02-19: Frontend masters UI refactored to one reusable page (`src/pages/Masters/MasterEntityPage.vue`) driven by `src/config/masters.js` for Products/Suppliers/Warehouses/WarehouseStorages/Carriers/Ports.
- 2026-02-19: Master API refactored to generic resource-based actions (`master.getRecords`, `master.createRecord`, `master.updateRecord`) shared across Products/Suppliers/Warehouses/WarehouseStorages/Carriers/Ports.
...
- 2026-02-19: Added `CONTEXT_HANDOFF.md` to bootstrap new AI context windows without losing project direction.
...
### 2. [Business Logic](BUSINESS_LOGIC.md)
...
*   **Context:** How APP.Resources dynamically routes API access to MASTERS/OPERATIONS/REPORTS files.
...
*   **Context:** Single-file bootstrapping brief for new AI sessions to resume work with full project continuity.
*   **Audience:** AI Agents, Developers, Project Owner.
...
### 13. [Operation Sheet Structure](OPERATION_SHEET_STRUCTURE.md)
*   **Context:** Schema for inbound operation sheets (Shipments, ShipmentItems, PortClearance, GoodsReceipts, GoodsReceiptItems, StockMovements).
*   **Audience:** DB Admins, Backend Developers.

### 14. [Procurement Sheet Structure](PROCUREMENT_SHEET_STRUCTURE.md)
*   **Context:** Schema for the full procurement workflow (Procurements, PRs, RFQs, Quotations, POs, Fulfillments).
*   **Audience:** DB Admins, Backend Developers, Operations.

### 15. [Accounts Sheet Structure](ACCOUNTS_SHEET_STRUCTURE.md)
*   **Context:** Schema for ChartOfAccounts, EntryTemplates, and five ledger sheets (Assets, Liabilities, Equity, Revenue, Expenses).
*   **Audience:** DB Admins, Backend Developers, Accountants.

### 16. [Dashboard Widgets Architecture](DASHBOARD_WIDGETS_ARCHITECTURE.md)
*   **Context:** Role-based widget system design for dynamic dashboard rendering by user roles.
*   **Audience:** Frontend Developers, Architects.

### 17. [Schema Refactoring Guide](SCHEMA_REFACTORING_GUIDE.md)
*   **Context:** How to safely add/remove/reorder columns using the AQL > Setup & Refactor menu without data loss.
*   **Audience:** Backend Developers, AI Agents.

### 18. [Frontend Detailed README](FRONTENT_README.md)
