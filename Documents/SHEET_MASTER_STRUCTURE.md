...
- **Columns**: `Code`, `Name`, `Province`, `Area`, `City`, `Country`, `Type`, `Licence`, `AccessRegion`, `Status`, `CreatedAt`, `UpdatedAt`, `Revision`, `CreatedBy`, `UpdatedBy`.
...
- **Columns**: `Code`, `Name`, `ContactPerson`, `Phone`, `Email`, `Country`, `Province`, `Area`, `City`, `CommunicationAddress`, `ShippingAddress`, `BillingAddress`, `MapLocationLink`, `Picture`, `Picture2`, `Picture3`, `Licence`, `TaxRegistrationNumber`, `TaxRegistrationName`, `AccessRegion`, `Status`, `CreatedAt`, `UpdatedAt`, `Revision`, `CreatedBy`, `UpdatedBy`.
...
- **Columns**: `Code`, `OutletCode`, `MaxStockValueLimit`, `VisitFrequencyDays`, `InvoiceDueDays`, `CreditLimit`, `PriceListCode`, `AccessRegion`, `Status`, `CreatedAt`, `UpdatedAt`, `Revision`, `CreatedBy`, `UpdatedBy`.
