/**
 * Outlets › View › ResourceActionNewInvoice — JS modifier (tier CP: resource + page).
 *
 * Opens the invoice wizard with this outlet already chosen, so it lists that outlet's uninvoiced consumptions immediately.
 *
 ...
 * so on its own it opens the invoice wizard with no outlet chosen, and the user has to pick
