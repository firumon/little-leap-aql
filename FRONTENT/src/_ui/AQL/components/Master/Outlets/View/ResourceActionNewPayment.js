/**
 * Outlets › View › ResourceActionNewPayment — JS modifier (tier CP: resource + page).
 *
 * Opens the payment wizard with this outlet already chosen, so it lists that outlet's open invoices immediately.
 *
 ...
 * so on its own it opens the payment wizard with no outlet chosen, and the user has to pick
