/**
 * Outlets › View › ResourceActionNewRestock — JS modifier (tier CP: resource + page).
 *
 * Opens the restock wizard with this outlet already chosen.
 *
 ...
 * so on its own it opens the restock wizard with no outlet chosen, and the user has to pick
