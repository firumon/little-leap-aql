...
defineOptions({ name: 'PurchaseRequisitionsReviewFormActionSendBack', inheritAttrs: false })

const props = defineProps({
  label: { type: [String, Function], default: 'Request Revision' },
  icon: { type: [String, Function], default: 'undo' },
  color: { type: [String, Function], default: 'warning' },
