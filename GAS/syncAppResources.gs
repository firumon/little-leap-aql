...
function initAppResourcesCodeConfig() {
    ...
    },
    {
        ...
        AdditionalActions: JSON.stringify([
            ...
            { "action": "Reject", "label": "Reject", "icon": "cancel", "color": "negative", "kind": "mutate", "confirm": false, "column": "Progress", "columnValue": "REJECTED", "fields": [{ "name": "ProgressRejectedComment", "label": "Rejection Reason", "type": "textarea", "required": true }], "visibleWhen": { "column": "Progress", "op": "in", "value": ["PENDING_APPROVAL", "APPROVED"] } },
