...
const APP_RESOURCES_CODE_CONFIG = [
    // --- MASTER RESOURCES ---
    {
        ...
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Product', groupPath: ['Masters', 'Product'], order: 1, label: 'Manage Products', icon: 'inventory_2', route: '/masters/products', pageTitle: 'Products', pageDescription: 'Manage product master records (parent models)', show: true, menuAccess: { require: 'canWrite' } }]),
    ...
    },
    {
        ...
        OwnerUserField: 'CreatedBy',
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Masters', groupPath: ['Masters', 'Product'], order: 2, label: 'SKUs', icon: 'style', route: '/masters/skus', pageTitle: 'SKUs', pageDescription: 'Manage sellable SKUs (child variants of a product)', show: true }]),
        UIFields: JSON.stringify([
    ...
    },
    {
        ...
        OwnerUserField: 'CreatedBy',
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Masters', groupPath: ['Masters', 'Procurement'], order: 3, label: 'Suppliers', icon: 'handshake', route: '/masters/suppliers', pageTitle: 'Suppliers', pageDescription: 'Manage supplier master records', show: true }]),
        UIFields: JSON.stringify([
            { header: 'Name', label: 'Name', type: 'text', required: true },
    ...
    },
    {
        ...
        OwnerUserField: 'CreatedBy',
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Warehouse', groupPath: ['Masters', 'Warehouse'], order: 1, label: 'Manage Warehouses', icon: 'warehouse', route: '/masters/warehouses', pageTitle: 'Warehouses', pageDescription: 'Manage warehouse master records', show: true }]),
        UIFields: JSON.stringify([
            { header: 'Name', label: 'Name', type: 'text', required: true },
    ...
    },
    {
        ...
        OwnerUserField: 'CreatedBy',
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Masters', groupPath: ['Masters', 'Logistics'], order: 5, label: 'Ports', icon: 'anchor', route: '/masters/ports', pageTitle: 'Ports', pageDescription: 'Manage port master records', show: true }]),
        UIFields: JSON.stringify([
            { header: 'Name', label: 'Name', type: 'text', required: true },
            { header: 'Country', label: 'Country', type: 'text' },
    ...
    },
    {
        ...
        OwnerUserField: 'CreatedBy',
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Masters', groupPath: ['Masters', 'Logistics'], order: 6, label: 'Carriers', icon: 'local_shipping', route: '/masters/carriers', pageTitle: 'Carriers', pageDescription: 'Manage carrier master records', show: true }]),
        UIFields: JSON.stringify([
            { header: 'Name', label: 'Name', type: 'text', required: true },
            { header: 'Type', label: 'Type', type: 'text' },
            { header: 'Phone', label: 'Phone', type: 'text' },
    ...
    },
    {
        ...
        OwnerUserField: 'CreatedBy',
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Procurement', groupPath: ['Operations', 'Procurement'], order: 0, label: 'Procurements', icon: 'shopping_cart', route: '/operations/procurements', pageTitle: 'Procurements', pageDescription: 'Central tracked procurement request', show: false }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
        PreAction: '',
    ...
    },
    {
        ...
        Menu: JSON.stringify([{ group: 'Procurement', groupPath: ['Operations', 'Procurement'], order: 1, label: 'Purchase Requisitions', icon: 'request_quote', route: '/operations/prs', pageTitle: 'Purchase Requisitions', pageDescription: 'Internal requests for purchase', show: true }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
        PreAction: '',
    ...
    },
    {
        ...
        OwnerUserField: 'CreatedBy',
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Procurement', groupPath: ['Operations', 'Procurement'], order: 3, label: 'PR Items', icon: 'list', route: '', pageTitle: 'PR Items', pageDescription: 'Items in Purchase Requisition', show: false }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
        PreAction: '',
    ...
    },
    {
        ...
        Menu: JSON.stringify([{ group: 'Procurement', groupPath: ['Operations', 'Procurement'], order: 2, label: 'RFQs', icon: 'compare_arrows', route: '/operations/rfqs', pageTitle: 'RFQs', pageDescription: 'Request For Quotation', show: true }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
        PreAction: '',
    ...
    },
    {
        ...
        OwnerUserField: 'CreatedBy',
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Procurement', groupPath: ['Operations', 'Procurement'], order: 5, label: 'RFQ Items', icon: 'list', route: '', pageTitle: 'RFQ Items', pageDescription: 'Items requested for quotation', show: false }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
        PreAction: '',
    ...
    },
    {
        ...
        OwnerUserField: 'CreatedBy',
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Procurement', groupPath: ['Operations', 'Procurement'], order: 6, label: 'RFQ Suppliers', icon: 'people', route: '', pageTitle: 'RFQ Suppliers', pageDescription: 'Suppliers targeted for RFQ', show: false }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
        PreAction: '',
    ...
    },
    {
        ...
        OwnerUserField: 'CreatedBy',
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Procurement', groupPath: ['Operations', 'Procurement'], order: 3, label: 'Supplier Quotations', icon: 'attach_money', route: '/operations/quotations', pageTitle: 'Supplier Quotations', pageDescription: 'Quotations received from suppliers', show: true }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
        PreAction: '',
    ...
    },
    {
        ...
        OwnerUserField: 'CreatedBy',
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Procurement', groupPath: ['Operations', 'Procurement'], order: 8, label: 'Quotation Items', icon: 'list', route: '', pageTitle: 'Quotation Items', pageDescription: '', show: false }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
        PreAction: '',
    ...
    },
    {
        ...
        Menu: JSON.stringify([{ group: 'Procurement', groupPath: ['Operations', 'Procurement'], order: 4, label: 'Purchase Orders', icon: 'fact_check', route: '/operations/pos', pageTitle: 'Purchase Orders', pageDescription: 'Orders sent to suppliers', show: true }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
        PreAction: '',
    ...
    },
    {
        ...
        OwnerUserField: 'CreatedBy',
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Procurement', groupPath: ['Operations', 'Procurement'], order: 10, label: 'PO Items', icon: 'list', route: '', pageTitle: 'PO Items', pageDescription: '', show: false }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
        PreAction: '',
    ...
    },
    {
        ...
        OwnerUserField: 'CreatedBy',
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Procurement', groupPath: ['Operations', 'Procurement'], order: 11, label: 'PO Documents', icon: 'folder', route: '', pageTitle: 'PO Fulfillments', pageDescription: 'Documents related to POs', show: false }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
        PreAction: '',
    ...
    },
    {
        ...
        Menu: JSON.stringify([{ group: 'Procurement', groupPath: ['Operations', 'Procurement'], order: 5, label: 'Shipments', icon: 'directions_boat', route: '/operations/shipments', pageTitle: 'Shipments', pageDescription: 'Manage inward shipments', show: true }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
        PreAction: '',
    ...
    },
    {
        ...
        OwnerUserField: 'CreatedBy',
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Operations', groupPath: ['Operations', 'Procurement'], order: 2, label: 'Shipment Items', icon: 'view_list', route: '', pageTitle: 'Shipment Items', pageDescription: 'Items in a shipment', show: false }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
        PreAction: '',
    ...
    },
    {
        ...
        Menu: JSON.stringify([{ group: 'Warehouse', groupPath: ['Operations', 'Warehouse'], order: 5, label: 'Port Clearance', icon: 'verified_user', route: '/operations/port-clearance', pageTitle: 'Port Clearance', pageDescription: 'Manage customs clearance', show: true }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
        PreAction: '',
    ...
    },
    {
        ...
        Menu: JSON.stringify([{ group: 'Warehouse', groupPath: ['Operations', 'Warehouse'], order: 6, label: 'Goods Receipts', icon: 'receipt_long', route: '/operations/goods-receipts', pageTitle: 'Goods Receipts', pageDescription: 'Manage inward warehouse receiving', show: true }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
        PreAction: '',
    ...
    },
    {
        ...
        OwnerUserField: 'CreatedBy',
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Operations', groupPath: ['Operations', 'Warehouse'], order: 5, label: 'GRN Items', icon: 'view_list', route: '', pageTitle: 'GRN Items', pageDescription: 'Items in a goods receipt', show: false }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
        PreAction: '',
    ...
    },
    {
        ...
        AdditionalActions: '',
        Menu: JSON.stringify([
            { group: 'Product', groupPath: ['Masters', 'Product'], order: 2, label: 'Manage Stock', icon: 'inventory', route: '/operations/manage-stock', pageTitle: 'Manage Stock', pageDescription: 'Add, adjust, or directly enter stock movements', show: true },
            { group: 'Warehouse', groupPath: ['Masters', 'Warehouse'], order: 2, label: 'Manage Stock', icon: 'inventory', route: '/operations/manage-stock', pageTitle: 'Manage Stock', pageDescription: 'Add, adjust, or directly enter stock movements', show: true },
            { group: 'Warehouse', groupPath: ['Operations', 'Warehouse'], order: 3, label: 'Stock Movements', icon: 'swap_horiz', route: '/operations/stock-movements', pageTitle: 'Stock Movements', pageDescription: 'Global ledger of inventory flows', show: true }
        ]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
    ...
    },
    {
        ...
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Warehouse', groupPath: ['Operations', 'Warehouse'], order: 4, label: 'Warehouse Storages', icon: 'inventory', route: '/operations/warehouse-storages', pageTitle: 'Warehouse Storages', pageDescription: 'Real-time updated inventory locations', show: true }]),
        UIFields: JSON.stringify([
    ...
    },
    {
        ...
        OwnerUserField: 'CreatedBy',
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Accounts', groupPath: ['Accounts'], order: 1, label: 'Chart Of Accounts', icon: 'account_balance_wallet', route: '/masters/chart-of-accounts', pageTitle: 'Chart of Accounts', pageDescription: 'COA Ledger structure', show: true }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
        PreAction: '',
    ...
    },
    {
        ...
        OwnerUserField: 'CreatedBy',
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Accounts', groupPath: ['Accounts'], order: 2, label: 'Entry Templates', icon: 'dynamic_form', route: '/masters/entry-templates', pageTitle: 'Entry Templates', pageDescription: 'Templates for accounting entries', show: true }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
        PreAction: '',
    ...
    },
    {
        ...
        OwnerUserField: 'CreatedBy',
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Accounts', groupPath: ['Accounts'], order: 3, label: 'Assets', icon: 'assured_workload', route: '/accounts/assets', pageTitle: 'Assets Tracker', pageDescription: 'Asset account entries', show: true }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
        PreAction: '',
    ...
    },
    {
        ...
        OwnerUserField: 'CreatedBy',
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Accounts', groupPath: ['Accounts'], order: 4, label: 'Liabilities', icon: 'account_balance', route: '/accounts/liabilities', pageTitle: 'Liabilities Tracker', pageDescription: 'Liability account entries', show: true }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
        PreAction: '',
    ...
    },
    {
        ...
        OwnerUserField: 'CreatedBy',
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Accounts', groupPath: ['Accounts'], order: 5, label: 'Equity', icon: 'monetization_on', route: '/accounts/equity', pageTitle: 'Equity Tracker', pageDescription: 'Equity account entries', show: true }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
        PreAction: '',
    ...
    },
    {
        ...
        OwnerUserField: 'CreatedBy',
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Accounts', groupPath: ['Accounts'], order: 6, label: 'Revenue', icon: 'trending_up', route: '/accounts/revenue', pageTitle: 'Revenue Tracker', pageDescription: 'Revenue account entries', show: true }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
        PreAction: '',
    ...
    },
    {
        ...
        OwnerUserField: 'CreatedBy',
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Accounts', groupPath: ['Accounts'], order: 7, label: 'Expenses', icon: 'trending_down', route: '/accounts/expenses', pageTitle: 'Expenses Tracker', pageDescription: 'Expense account entries', show: true }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'FALSE',
        PreAction: '',
    ...
    // --- FUNCTIONAL RESOURCES ---
    {
        ...
        OwnerUserField: '',
        AdditionalActions: '',
        Menu: JSON.stringify([{ group: 'Masters', groupPath: ['Masters'], order: 99, label: 'Bulk Upload', icon: 'cloud_upload', route: '/masters/bulk-upload', pageTitle: 'Bulk Upload Masters', pageDescription: 'Upload bulk data to any master resource', show: true }]),
        UIFields: JSON.stringify([]),
        IncludeInAuthorizationPayload: 'TRUE',
        Functional: 'TRUE',
        PreAction: '',
