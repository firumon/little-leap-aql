...
function initAppResourcesCodeConfig() {
    ...
    },
    {
        ...
        AdditionalActions: JSON.stringify([
            { "action": "Complete", "label": "Complete", "subtitle": "{$outlet.Name}", "icon": "task_alt", "color": "positive", "kind": "mutate", "confirm": false, "column": "Progress", "columnValue": "COMPLETED", "columnValueOptions": [], "fields": [{ "name": "Comment", "label": "Completion Comment", "type": "textarea", "required": false }], "targets": [{ "resource": "OutletVisits", "mode": "create", "key": "nextVisit", "label": "Next Planned Visit (optional)", "when": { "field": "Date", "op": "notEmpty" }, "fields": [{ "name": "OutletCode", "from": "$record.OutletCode" }, { "name": "Progress", "value": "PLANNED" }, { "name": "Status", "value": "Active" }, { "name": "ProgressPlannedAt", "value": "$now" }, { "name": "ProgressPlannedBy", "value": "$userCode" }, { "name": "Date", "label": "Next Visit Date", "type": "date", "required": false }, { "name": "ProgressPlannedComment", "value": "Auto planned after completed visit" }] }], "visibleWhen": { "column": "Progress", "op": "eq", "value": "PLANNED" } },
            { "action": "Postpone", "label": "Postpone", "subtitle": "{$outlet.Name}", "icon": "event_repeat", "color": "warning", "kind": "mutate", "confirm": false, "column": "Progress", "columnValue": "POSTPONED", "columnValueOptions": [], "fields": [{ "name": "Comment", "label": "Postpone Reason", "type": "textarea", "required": true }], "targets": [{ "resource": "OutletVisits", "mode": "create", "key": "newVisit", "label": "Rescheduled Visit", "when": { "field": "Date", "op": "notEmpty" }, "fields": [{ "name": "OutletCode", "from": "$record.OutletCode" }, { "name": "Progress", "value": "PLANNED" }, { "name": "Status", "value": "Active" }, { "name": "ProgressPlannedAt", "value": "$now" }, { "name": "ProgressPlannedBy", "value": "$userCode" }, { "name": "Date", "label": "New Visit Date", "type": "date", "required": true }, { "name": "ProgressPlannedComment", "label": "Planned Comment", "type": "textarea", "from": "$record.ProgressPlannedComment" }] }], "visibleWhen": { "column": "Progress", "op": "eq", "value": "PLANNED" } },
            { "action": "Cancel", "label": "Cancel", "subtitle": "{$outlet.Name}", "icon": "cancel", "color": "negative", "kind": "mutate", "confirm": false, "column": "Progress", "columnValue": "CANCELLED", "columnValueOptions": [], "fields": [{ "name": "Comment", "label": "Cancellation Reason", "type": "textarea", "required": true }], "targets": [{ "resource": "OutletVisits", "mode": "create", "key": "replacementVisit", "label": "Replacement Visit (optional)", "when": { "field": "Date", "op": "notEmpty" }, "fields": [{ "name": "OutletCode", "from": "$record.OutletCode" }, { "name": "Progress", "value": "PLANNED" }, { "name": "Status", "value": "Active" }, { "name": "ProgressPlannedAt", "value": "$now" }, { "name": "ProgressPlannedBy", "value": "$userCode" }, { "name": "Date", "label": "Replacement Date", "type": "date", "required": false }, { "name": "ProgressPlannedComment", "value": "Auto planned after cancelled visit" }] }], "visibleWhen": { "column": "Progress", "op": "eq", "value": "PLANNED" } }
        ]),
