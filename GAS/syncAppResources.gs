...
function initAppResourcesCodeConfig() {
    ...
    },
    {
        ...
        AdditionalActions: JSON.stringify([
            ...
            {"action":"MarkPaid","label":"Mark Paid","icon":"paid","color":"positive","kind":"mutate","confirm":true,"column":"Progress","columnValue":"PAID","columnValueOptions":[],"fields":[{"name":"SettlementReason","label":"Settlement Reason","type":"select","required":true,"options":["Waived Off","RoundOff","Bad Debt / Write-Off","Underpayment Settled","Other"]},{"name":"SettlementMismatchAmount","label":"Settlement Mismatch (+/-)","type":"number","required":false},{"name":"Comment","label":"Comment","type":"textarea","required":false}],"visibleWhen":{"column":"Progress","op":"in","value":["PENDING_PAYMENT","PARTIALLY_PAID"]}},
