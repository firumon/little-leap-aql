...
| **OutletVisitsOverdue** | `A10` | *None* (relative to `TODAY()`) | Outlet `OutletVisits!A2:W` (Cols 1-3,5,8,18), Master `Outlets!A2:U` (Cols 1,2) | [OutletVisitsOverdue.md](file:///f:/LITTLE%20LEAP/AQL/Sheet%20Formulas/Reports/OutletVisitsOverdue.md) |
| **OutletVisitHistory** | `A20` (List), `E12` (Card), `U10`, `U15`, `AD10`, `AD15` (Counts) | `$H$11` (Outlet Code) | Master `Outlets!A2:J` (Cols 1-4,6-9), Outlet `OutletVisits!A2:W` (Cols 2,3,5,8,11,14,17,18) | [OutletVisitHistory.md](file:///f:/LITTLE%20LEAP/AQL/Sheet%20Formulas/Reports/OutletVisitHistory.md) |
