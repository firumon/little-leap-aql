...
| **ConsumptionInvoice** | `A10` | `$AB$6` (Consumption Invoice Code) | Outlet `OutletConsumptionInvoices!A2:AA` (Cols 1-5,7-10,13,14,27), `OutletConsumptionInvoiceItems!A2:K` (Cols 2-11), Master `Outlets!A2:B` (Cols 1,2), View `SKU!A2:I` (Cols 1,2,4,6,9) | [ConsumptionInvoice.md](file:///f:/LITTLE%20LEAP/AQL/Sheet%20Formulas/Reports/ConsumptionInvoice.md) |
| **OutletInvoiceHistory** | `A10` | `$AB$6` (Outlet Code) | Outlet `OutletConsumptionInvoices!A2:AA` (Cols 1,3-5,9,10,13,14,27), `OutletConsumptionInvoiceItems!A2:K` (Cols 2-6,11), View `SKU!A2:G` (Cols 1,2,4,6), Master `Outlets!A2:B` (Cols 1,2) | [OutletInvoiceHistory.md](file:///f:/LITTLE%20LEAP/AQL/Sheet%20Formulas/Reports/OutletInvoiceHistory.md) |
| **InvoiceRecords** | `A15` | `$J$11` (Date), `$J$12` (User), `$J$13` (Progress) | Outlet `OutletConsumptionInvoices!A2:AA` (Cols 1,3-5,9,10,13,14,27), `OutletConsumptionInvoiceItems!A2:K` (Cols 2-6,11), View `SKU!A2:G` (Cols 1,2,4,6), Master `Outlets!A2:B` (Cols 1,2) | [InvoiceRecords.md](file:///f:/LITTLE%20LEAP/AQL/Sheet%20Formulas/Reports/InvoiceRecords.md) |
| **Payment** | `A10` | `$AB$6` (Payment Code) | Outlet `OutletPayments!A2:Q` (Cols 1-9,16), `OutletConsumptionInvoices!A2:AA` (Cols 1,3,7,8,14), Master `Outlets!A2:Q` (Cols 1-9) | [Payment.md](file:///f:/LITTLE%20LEAP/AQL/Sheet%20Formulas/Reports/Payment.md) |
