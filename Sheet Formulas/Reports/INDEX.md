...
| **OutletVisitsToday** | `A10` | *None* (relative to `TODAY()`) | Outlet `OutletVisits!A2:R` (Cols 1-3,5,8,18), Master `Outlets!A2:B` (Cols 1,2) | [OutletVisitsToday.md](file:///f:/LITTLE%20LEAP/AQL/Sheet%20Formulas/Reports/OutletVisitsToday.md) |
| **OutletVisitsTomorrowAndUpcomig** | `A10` | *None* (relative to `TODAY()`) | Outlet `OutletVisits!A2:R` (Cols 1-3,5,8,18), Master `Outlets!A2:B` (Cols 1,2) | [OutletVisitsTomorrowAndUpcomig.md](file:///f:/LITTLE%20LEAP/AQL/Sheet%20Formulas/Reports/OutletVisitsTomorrowAndUpcomig.md) |
| **OutletVisitsOverdue** | `A10` | *None* (relative to `TODAY()`) | Outlet `OutletVisits!A2:X` (Cols 1-3,5,8,18), Master `Outlets!A2:U` (Cols 1,2) | [OutletVisitsOverdue.md](file:///f:/LITTLE%20LEAP/AQL/Sheet%20Formulas/Reports/OutletVisitsOverdue.md) |
| **OutletVisitHistory** | `A20` (List), `E12` (Card), `U10`, `U15`, `AD10`, `AD15` (Counts) | `$H$11` (Outlet Code) | Master `Outlets!A2:J` (Cols 1-4,6-9), Outlet `OutletVisits!A2:X` (Cols 2,3,5,8,11,14,17,18) | [OutletVisitHistory.md](file:///f:/LITTLE%20LEAP/AQL/Sheet%20Formulas/Reports/OutletVisitHistory.md) |
...
| **Delivery** | `A10` | `$AB$6` (Delivery ID) | Outlet `OutletDeliveries!A2:U` (Cols 1-5), `OutletRestockItems!A2:Q` (Cols 1,2,4,6,7,11,12), Master `Outlets!A2:B` (Cols 1,2), View `SKU!A2:G` (Cols 1,2,4,6), Outlet `OutletRestocks!A2:T` (Cols 1,3) | [Delivery.md](file:///f:/LITTLE%20LEAP/AQL/Sheet%20Formulas/Reports/Delivery.md) |
| **DeliveryRecords** | `A14` | `$J$11` (User), `$J$12` (Date) | Outlet `OutletDeliveries!A2:U` (Cols 1-5,15), `OutletRestockItems!A2:Q` (Cols 1,2,4,6,7,11), Master `Outlets!A2:B` (Cols 1,2), View `SKU!A2:G` (Cols 1,2,4,6), Outlet `OutletRestocks!A2:T` (Cols 1,3) | [DeliveryRecords.md](file:///f:/LITTLE%20LEAP/AQL/Sheet%20Formulas/Reports/DeliveryRecords.md) |
...
| **ConsumptionInvoice** | `A10` | `$AB$6` (Consumption Invoice Code) | Outlet `OutletConsumptionInvoices!A2:AB` (Cols 1-3,5,6,8,9,12,15,28), `OutletConsumptionInvoiceItems!A2:K` (Cols 2-11), Master `Outlets!A2:B` (Cols 1,2), View `SKU!A2:I` (Cols 1,2,4,6,9) | [ConsumptionInvoice.md](file:///f:/LITTLE%20LEAP/AQL/Sheet%20Formulas/Reports/ConsumptionInvoice.md) |
| **OutletInvoiceHistory** | `A10` | `$AB$6` (Outlet Code) | Outlet `OutletConsumptionInvoices!A2:AB` (Cols 1,3,5,6,8,9,15,28), `OutletConsumptionInvoiceItems!A2:K` (Cols 2-6,11), View `SKU!A2:G` (Cols 1,2,4,6), Master `Outlets!A2:B` (Cols 1,2) | [OutletInvoiceHistory.md](file:///f:/LITTLE%20LEAP/AQL/Sheet%20Formulas/Reports/OutletInvoiceHistory.md) |
| **InvoiceRecords** | `A15` | `$J$11` (Date), `$J$12` (User), `$J$13` (Progress) | Outlet `OutletConsumptionInvoices!A2:AB` (Cols 1,3,5,6,8,9,15,28), `OutletConsumptionInvoiceItems!A2:K` (Cols 2-6,11), View `SKU!A2:G` (Cols 1,2,4,6), Master `Outlets!A2:B` (Cols 1,2) | [InvoiceRecords.md](file:///f:/LITTLE%20LEAP/AQL/Sheet%20Formulas/Reports/InvoiceRecords.md) |
| **Payment** | `A10` | `$AB$6` (Payment Code) | Outlet `OutletPayments!A2:Q` (Cols 1-9,16), `OutletConsumptionInvoices!A2:AB` (Cols 1,3,8,9,15), Master `Outlets!A2:Q` (Cols 1-9) | [Payment.md](file:///f:/LITTLE%20LEAP/AQL/Sheet%20Formulas/Reports/Payment.md) |
| **OutletPaymentHistory** | `A10` | `$AB$6` (Outlet Code) | Outlet `OutletPayments!A2:Q` (Cols 1-3,5,6,8,16), Master `Outlets!A2:B` (Cols 1,2) | [OutletPaymentHistory.md](file:///f:/LITTLE%20LEAP/AQL/Sheet%20Formulas/Reports/OutletPaymentHistory.md) |
| **PaymentRecords** | `A15` | `$J$11` (Date), `$J$12` (User), `$J$13` (Mode) | Outlet `OutletPayments!A2:Q` (Cols 1-3,5,6,8,16), Master `Outlets!A2:B` (Cols 1,2) | [PaymentRecords.md](file:///f:/LITTLE%20LEAP/AQL/Sheet%20Formulas/Reports/PaymentRecords.md) |
| **Return** | `A10` | `$AB$6` (Outlet Return Code) | Outlet `OutletReturns!A2:AC` (Cols 1-22), Master `Outlets!A2:B` (Cols 1,2), `Warehouses!A2:B` (Cols 1,2), View `SKU!A2:G` (Cols 1,2,4,6) | [Return.md](file:///f:/LITTLE%20LEAP/AQL/Sheet%20Formulas/Reports/Return.md) |
| **ReturnRecords** | `A15` | `$J$11` (User), `$J$12` (Date), `$J$13` (Reason) | Outlet `OutletReturns!A2:AC` (Cols 1-16,22,23), Master `Outlets!A2:B` (Cols 1,2), Views `SKU!A2:G` (Cols 1,2,4,6), Master `Warehouses!A2:B` (Cols 1,2) | [ReturnRecords.md](file:///f:/LITTLE%20LEAP/AQL/Sheet%20Formulas/Reports/ReturnRecords.md) |
| **OutletReturnHistory** | `A10` | `$AB$6` (Outlet Code) | Outlet `OutletReturns!A2:AC` (Cols 1-23), Master `Outlets!A2:B` (Cols 1,2), `Warehouses!A2:B` (Cols 1,2), View `SKU!A2:G` (Cols 1,2,4,6) | [OutletReturnHistory.md](file:///f:/LITTLE%20LEAP/AQL/Sheet%20Formulas/Reports/OutletReturnHistory.md) |
...
| **ProductReturnHistory** | `A10` | `$AB$6` (Product Code) | Outlet `OutletReturns!A2:AC` (Cols 1-23), Master `Outlets!A2:B` (Cols 1,2), `Warehouses!A2:B` (Cols 1,2), View `SKU!A2:G` (Cols 1,2,3,4,6) | [ProductReturnHistory.md](file:///f:/LITTLE%20LEAP/AQL/Sheet%20Formulas/Reports/ProductReturnHistory.md) |
